...
export const CHAT_SELECT_PARTICIPANT_FOR_CALL_SHOWING = "CHAT_SELECT_PARTICIPANT_FOR_CALL_SHOWING";
export const CHAT_CALL_BOX_SHOWING = "CHAT_CALL_BOX_SHOWING";
export const CHAT_CALL_GROUP_SETTINGS_SHOWING = "CHAT_CALL_GROUP_SETTINGS_SHOWING";
export const CHAT_CALL_GROUP_VIDEO_VIEW_MODE = "CHAT_CALL_GROUP_VIDEO_VIEW_MODE";
export const CHAT_CALL_STATUS = "CHAT_CALL_STATUS";
...
export const CHAT_CALL_PARTICIPANT_REMOVED = "CHAT_CALL_PARTICIPANT_REMOVED";
export const CHAT_CALL_PARTICIPANT_JOINED = "CHAT_CALL_PARTICIPANT_JOINED";
export const CHAT_CALL_PARTICIPANT_LEFT = "CHAT_CALL_PARTICIPANT_LEFT";
export const CHAT_CALL_PARTICIPANT_LIST_PRELOAD = "CHAT_CALL_PARTICIPANT_LIST_PRELOAD";
export const CHAT_CALL_PARTICIPANT_LIST_CHANGE = "CHAT_CALL_PARTICIPANT_LIST_CHANGE";
export const CHAT_CALL_PARTICIPANT_LIST = buildPromiseMessage.bind(null, "CHAT_CALL_PARTICIPANT_LIST");
...
export const THREAD_EXPORT_MESSAGES_SHOWING = "THREAD_EXPORT_MESSAGES_SHOWING";
